...
2.「https://chromedriver.storage.googleapis.com/index.html 」にアクセスし、自分の使用しているChromeのバージョンと一致した「chromedriver_win32.zip」をダウンロードします（chromeのバージョンはchrome://settings/help から確認できる。chromeを持っていない場合はインストールすること）。
